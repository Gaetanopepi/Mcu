...
(function (global) {
      ...
      if (isTvFormat(item.format)) {
        ...
        if (best) {
          result = {
            ...
            matchedTitle: best.name, posterPath: best.poster_path, overview: best.overview,
            resolvedAt: Date.now(),
          };
        }
      } else {
        ...
        if (best) {
          result = {
            ...
            matchedTitle: best.title, posterPath: best.poster_path, overview: best.overview,
            resolvedAt: Date.now(),
          };
        }
      }
  ...
  global.TMDB = {
    ...
    resolveItem, fetchEpisodes, posterUrl, stillUrl, isTvFormat,
