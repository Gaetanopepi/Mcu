...
const TMDB_METADATA = {
 "generatedAt": "2026-08-13T19:16:44Z",
 "region": "IT",
 "language": "it-IT",
 "items": {
  "1": {
  ...
  "127": {
   ...
   "tmdbId": 139099,
   "seasonNumber": 1,
   "titleIt": "The Consultant",
   "posterPath": "/p7xzW8f6sHltgcuxCUc88FiJEJw.jpg",
   "backdropPath": "/aljOqXXt0TVCoOoaAS4SmmjmrGC.jpg",
   "overview": "Dopo un'orribile tragedia alla CompWare, un'azienda di videogame con sede nel centro di Los Angeles, un misterioso consulente, Regus Patoff, si presenta in città e assume il comando.",
   "overviewLang": "it",
   "voteAverage": 6.827,
   "firstAirDate": "2023-02-23",
   "providers": [
    {
     "name": "Amazon Prime Video",
     "logoPath": "/pvske1MyAoymrs5bguRfVqYiM9a.jpg"
   ...
   "episodes": [
    {
     "number": 1,
     "name": "Creatore",
     "overview": "Dopo un'orribile tragedia al CEO della CompWare, un misterioso consulente ne assume il comando.",
     "stillPath": "/lrFzvTMeAKcdQ7fxDuLzV4yUNec.jpg",
     "airDate": "2023-02-23",
     "runtime": 34
    },
    {
     "number": 2,
     "name": "Mamma",
     "overview": "In cerca di risposte sulla morte del figlio, Mamma Sang fa visita alla CompWare. Elaine mette in dubbio le ragioni di Regus, mentre Craig fa un inaspettato progresso su un nuovo gioco.",
     "stillPath": "/vj5fJ6so9L9rkQoO4T3TNvcAnJU.jpg",
     "airDate": "2023-02-23",
     "runtime": 31
    },
    {
     "number": 3,
     "name": "Venerdì",
     "overview": "Regus si autoinvita a uscire con Craig, ma l'incontro prende una brutta piega. Intanto, mentre si prepara per un appuntamento, Elaine trova la chiave dell'archivio.",
     "stillPath": "/xAW0UdadNOZ2GZ5e96zrlKOPFHK.jpg",
     "airDate": "2023-02-23",
     "runtime": 33
    },
    {
     "number": 4,
     "name": "Sang",
     "overview": "Torniamo indietro all'incontro di Sang-woo con Regus Patoff e al loro contratto vincolante. Nel presente, Craig è ancora scombussolato dall'uscita con il capo, mentre Elaine fa progressi nel mantenere la CompWare a galla.",
     "stillPath": "/lSdZnEt7rKpYuTrCvHwsqZjL0iw.jpg",
     "airDate": "2023-02-23",
     "runtime": 33
    },
    {
     "number": 5,
     "name": "Malato",
     "overview": "Determinato a scovare l'enigmatico Frank Florez, Craig si reca a Pomona. In ufficio, scoppia il caos quando Regus Patoff annuncia la disponibilità di una suite manageriale.",
     "stillPath": "/z6SIS8jmF6AQYAdnrB5MAgWuSra.jpg",
     "airDate": "2023-02-23",
     "runtime": 32
    },
    {
     "number": 6,
     "name": "Vetro",
     "overview": "Con l'ultimo gioco della CompWare vicino al lancio, Elaine teme il peggio per gli effetti che questo ha sui giocatori. Nonostante gli sforzi di Craig in chiesa, Patti sente l'attrazione di Regus Patoff, che la allontana dal fidanzato.",
     "stillPath": "/af1U89hh7ruAtiJ4bc7k8opPGcy.jpg",
     "airDate": "2023-02-23",
     "runtime": 33
    },
    {
     "number": 7,
     "name": "Elefante",
     "overview": "Giorni dopo, Patti non è ancora tornata a casa, portando Craig a una spirale di pensieri. Incastrata in un compito impossibile, Elaine si ritrova a chiamare un suo ex per chiedergli aiuto.",
     "stillPath": "/3SFw629HshnLxAMidaVbAbMr7XV.jpg",
     "airDate": "2023-02-23",
     "runtime": 35
    },
    {
     "number": 8,
     "name": "Martello",
     "overview": "Mr. Sang’s Jungle Odyssey arriva sul mercato con grande successo. Elaine continua a mettere in discussione la sua moralità. Craig affronta ciò che lo tormenta dall'inizio della stagione, e Regus adocchia la sua prossima impresa.",
     "stillPath": "/bSeVCUTV1QH7AKpk3llzApTQm43.jpg",
     "airDate": "2023-02-23",
     "runtime": 36
    }
   ]
